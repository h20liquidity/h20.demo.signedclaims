...
// this is a completely insecure function, here to serve merely as an example of how to generate a signed context
// in a real-world scenario, you would never hardcode a private key like this
// this would be done in a secure environment, not on the client side
export const generateSignedContext = async ({
	...
	const account = privateKeyToAccount(
		'0xdcbe53cbf4cbee212fe6339821058f2787c7726ae0684335118cdea2e8adaafd' // just an example, this would happen in a secure environment
	)
